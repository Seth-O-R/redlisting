# Plotting occurences against POWO native range.
# Seth Ratcliffe - s.ratcliffe@kew.org
# 31/03/2023

# Packages and libraries ----
install.packages(c('tidyverse', 'CoordinateCleaner', 'sf', 'leaflet', 'rWCVP', 'terra'))
pacman::p_load('tidyverse', 'CoordinateCleaner', 'sf', 'leaflet', 'rWCVP', 'terra')

# Shiny GeoCAT ---- 
# Data import 
raw_occs <- read.csv("..............") %>% # Please note this script is set up to take csv from shiny geocat, you may have to fiddle with this bit or do some data management to get it to work with csv formatted in otherways.
